...
class BackupStyleLoss:
    ...
    def _get_sample_weights(self, task_id, indices, is_val):
        ...
        current_weights = self.sample_weights.get(self._split_name(is_val), {})
...
def create_loss_function(
    ...
    task_to_index 保留为兼容参数；备份语义不再按输出维度拆分数据项。
    """
